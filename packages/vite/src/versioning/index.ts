...
export function resolveVersionContext(pathname: string, manifest: VersionManifest | null): VersionContext | null {
  if (!manifest)
    return null
...
export function resolveVersionSwitch(pathname: string, targetVersionId: string, manifest: VersionManifest): VersionSwitchTarget | null {
...
export function resolveVersionedPath(to: string, context: VersionContext | null, manifest: VersionManifest | null): string {
