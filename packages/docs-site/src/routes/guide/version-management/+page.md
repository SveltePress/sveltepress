...
:::since[Overlay historical HTML]{version="2026-09-17" id="versions-overlay-html" summary="Vite prerenders current locale trees only; frozen /v/ pages are overlaid HTML that share current _app assets."}
