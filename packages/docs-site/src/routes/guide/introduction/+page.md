...
The navbar **Playground** opens a Feature directory of in-browser Starters. Playground v1 ships Basic Writing on a thin Default Theme starter. Guide pages keep frozen Live code; the Blog demo stays a finished showcase.
