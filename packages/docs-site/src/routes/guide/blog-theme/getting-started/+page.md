...
The navbar **Blog demo** is that finished showcase. The navbar **Playground** is a different job: it opens the Blog starter so you can edit Configuration, Writing posts, Features, and Customisation in the Hosted editor. This getting-started page is not a Playground Entry and has no Open in Playground control.
