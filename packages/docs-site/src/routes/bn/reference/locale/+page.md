...
প্লেগ্রাউন্ডের [ভার্চুয়াল মডিউল](/playground/virtual-modules/) এন্ট্রি Kitchen-sink starter চালু করে, যেখানে `virtual:sveltepress/site`, `locale` এবং `versions` সব পপুলেট থাকে। সেই পাতা markdown-এ সরাসরি Svelte লিখে এই পাতার মতোই `JsonViewer` দিয়ে রেন্ডার করে। এই ডকুমেন্ট পাতা svelte live রাখে যাতে সোর্স কোড ও রেন্ডার ফলাফল একসাথে দেখা যায়। এই পাতার Open in Playground সেখানেই যায়।
