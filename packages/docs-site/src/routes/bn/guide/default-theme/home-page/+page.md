...
* `to`
  অ্যাকশন বাটনের লিংক। Internal path logical route হওয়া উচিত, যেমন `/guide/introduction/`; Default Theme সক্রিয় লোকেলের prefix যোগ করবে।
* `external`
...
* `link`
  ...
  Internal path logical route হওয়া উচিত, যেমন `/guide/markdown/frontmatter/`; Default Theme সক্রিয় লোকেলের prefix যোগ করবে।
