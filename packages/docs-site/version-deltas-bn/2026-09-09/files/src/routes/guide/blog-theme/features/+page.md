...
ইমেজ তৈরি ও রেন্ডারার লোড করা সম্পূর্ণ এড়িয়ে যেতে `enabled: false` দিন।

resvg রেন্ডারারের জন্য নেটিভ Node.js অ্যাডঅন দরকার, যা StackBlitz WebContainers-এর মতো ব্রাউজার কনটেইনার সমর্থন করে না। থিম রেন্ডারার ইমপোর্ট করার আগে এই সীমাবদ্ধতা যাচাই করে। অ্যাডঅন নিষ্ক্রিয় থাকলে বা রেন্ডারার লোড করা না গেলে থিম সতর্কবার্তা দেখিয়ে OG PNG তৈরি এড়িয়ে যায়; ব্লগ চালু হয় এবং বিদ্যমান ইমেজ অক্ষত থাকে। ডেপ্লয়ের আগে নেটিভ Node.js পরিবেশে হালনাগাদ OG ইমেজ তৈরি করুন।
