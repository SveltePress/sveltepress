...
export const LIST_PAGE_SERVER_LOAD = `import { blogConfig } from 'virtual:sveltepress/blog-config'
...
export const PAGE_N_SERVER_LOAD = `import { error } from '@sveltejs/kit'
...
<style>
  ...
  .sp-tag-pill:hover {
    background: var(--sp-blog-border, #3f1c04);
    text-decoration: none;
  }
  .sp-tag-pill__count {
    color: var(--sp-blog-muted, #a16207);
    font-size: 0.8rem;
  }
</style>
`
