...
* `theme?: ThemeResolved`  
  ...
  * `remarkPlugins`  
    Remark plugins. You can visit [Remark](https://github.com/remarkjs/remark) for more information
  * `rehypePlugins`  
    Rehype plugins. You can visit [Rehype](https://github.com/rehypejs/rehype) for more information
  ...
  * `clientImports?: string[]`  
    Some imports that would be used in the global layout js entry.   
    It is useful when you want to import some global styles.   
...
![image](https://user-images.githubusercontent.com/41723543/212241505-c1daae81-903c-4c26-a910-2cf90253a1bf.png)
* Svelte live code
